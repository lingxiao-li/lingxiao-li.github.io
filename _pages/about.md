...
---
**Research:** As a researcher in machine learning, Lingxiao is focused on improving the generalization ability of machine learning models with minimum supervision. His interests span multiple areas, including **generative models**, **self-supervised learning**, **representation learning**, and **domain generalization**.
